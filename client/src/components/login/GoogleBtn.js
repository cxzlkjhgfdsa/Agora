...
function GoogleBtn() {
    const GOOGLE_AUTH_URL = `${process.env.REACT_APP_SERVER_BASE_URL}/oauth2/authorize/google?redirect_uri=${process.env.REACT_APP_SERVER_BASE_URL}/oauth2/code/google`;
